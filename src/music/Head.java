...
public class Head extends Mass implements Comparable<Head> {
    ...
    public int line;
    public Time time;
    public Glyph forcedGlyph = null; // hook, placeholder for functionality that haven't been implement.
    public boolean wrongSide = false;
    public Stem stem = null; // Is this one correct ????????????????????????
